...
from constantQT.series import (Series, Segment)
import constantQT.spectral as spectral
from constantQT.utilityaccess import (_fft_length_default, fir_from_transfer, recommended_overlap)
import constantQT.qtransform as qtransform
