...
from constantQT.spectral._registry import (get_method, register_method)
from constantQT.spectral._scipy import (
    bartlett,
    csd,
    median,
    rayleigh,
...
from constantQT.spectral._ui import (psd, spectrogram, average_spectrogram)
